...
type Service interface {
	GenRetailV3(companyId, apiKey string, payload *genRetailRequest) (*model.ScoreezyAPIResponse[dataGenRetailV3], error)
...
func (svc *service) GenRetailV3(companyId, apiKey string, payload *genRetailRequest) (*model.ScoreezyAPIResponse[dataGenRetailV3], error) {
	...
	result, err := svc.repo.GenRetailV3API(apiKey, payload)
	if err != nil {
