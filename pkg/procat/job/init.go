...
func SetupInit(apiGroup fiber.Router, cfg *config.Config, client httpclient.HTTPClient) {
	...
	apiGroup.Get("/:product_slug/jobs/:job_id/export", middleware.AdminAuth(), middleware.GetJWTPayloadFromCookie(), controller.ExportJobDetails)
	...
	apiGroup.Get("/:product_slug/jobs-summary/export", middleware.AdminAuth(), middleware.GetJWTPayloadFromCookie(), controller.ExportJobDetailsByDateRange)
}
