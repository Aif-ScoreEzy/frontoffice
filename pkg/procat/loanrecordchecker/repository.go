...
type Repository interface {
	...
	CallGetLoanRecordCheckerJobDetailAPI(filter *loanRecordCheckerFilter) (*http.Response, error)
}
...
func (repo *repository) CallGetLoanRecordCheckerJobDetailAPI(filter *loanRecordCheckerFilter) (*http.Response, error) {
	apiUrl := repo.Cfg.Env.AifcoreHost + "/api/core/job/" + filter.JobId + "/detail"
